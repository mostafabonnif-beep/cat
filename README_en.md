...
**Current Version**: 7.33.2-pro — the tool learns which title styles/topics bring views (content analytics), and a quality gate drops genuinely weak segments before export
