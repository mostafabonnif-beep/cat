...
[![Tests](https://img.shields.io/badge/tests-1215%20passed-brightgreen)](tests/)
...
**Versão Atual**: 7.33.3-pro — a seleção aprende com os resultados do seu canal (estilos vencedores são preferidos) e as variantes para outra plataforma são verificadas visualmente antes do upload
