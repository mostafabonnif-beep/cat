...
[![Tests](https://img.shields.io/badge/tests-1204%20passed-brightgreen)](tests/)
...
**Versão Atual**: 7.33.2-pro — a ferramenta aprende quais estilos de título/tópicos trazem views (análise de conteúdo) e um portão de qualidade descarta segmentos genuinamente fracos
